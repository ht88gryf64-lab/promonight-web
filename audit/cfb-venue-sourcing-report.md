...
- Tier: CONFLICT
- Sub-key verdict: **conflicting**
- Note: lot list superseded by the campus policy library and KU Parking; stored text truncated mid-list (section 4)
