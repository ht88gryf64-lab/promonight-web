  ...
  return (
    <LegalLayout title="Privacy Policy" updated="April 26, 2026">
      ...
      <ul>
        ...
        <li><strong>Firebase Cloud Messaging (FCM) token</strong> &mdash; a device identifier collected and stored so we can deliver messages to your device. We do not currently send any; promo-day reminders are scheduled by the app on your device rather than sent from our servers. If we begin sending messages, this token is what would be used.</li>
